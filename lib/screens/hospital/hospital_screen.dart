                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => Seoul()));
                    },
                    child: Text(
                      '서 울',
              ...
              children: [
                Container(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => Gangnam()));
                    },
                    child: Text(
                      '강남구',
                      style: TextStyle(fontSize: 20, color: Colors.white),
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => Gangdong()));
                    },
                    child: Text(
                      '강동구',
                      style: TextStyle(fontSize: 20, color: Colors.white),
              ...
              children: [
                Container(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => Guro()));
                    },
                    child: Text(
                      '구로구',
                      style: TextStyle(fontSize: 20, color: Colors.white),
